...
import { Yuwidget1Contribution } from './widget/yutools/widgets/Yuwidget1Contribution.js';
import { Yuwidget2Contribution } from './widget/yutools/widgets/Yuwidget2Contribution.js';
import { Yuwidget3Contribution } from './widget/yutools/widgets/Yuwidget3Contribution.js';
import { Yuwidget4Contribution } from './widget/yutools/widgets/Yuwidget4Contribution.js';
import { Yuwidget5Contribution } from './widget/yutools/widgets/Yuwidget5Contribution.js';
import { Yuwidget6Contribution } from './widget/yutools/widgets/Yuwidget6Contribution.js';
import { BrowserProfileContribution } from './widget/yutools/widgets/BrowserProfileContribution.js';
...
/////////////////////////// TAMBAHAN
export class Yuwidget1WidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.Yuwidget1Widget';
	constructor() {
		super({
			id: Yuwidget1WidgetAction.ID,
			label: 'Yuwidget1Widget',
			alias: 'Yuwidget1Widget',
			precondition: undefined,
			// kbOpts: {
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		Yuwidget1Contribution.get(editor).toggle();
	}
}
registerEditorAction(Yuwidget1WidgetAction);
registerEditorContribution(
	Yuwidget1Contribution.ID,
	Yuwidget1Contribution,
	EditorContributionInstantiation.Lazy
);

export class Yuwidget2WidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.Yuwidget2Widget';
	constructor() {
		super({
			id: Yuwidget2WidgetAction.ID,
			label: 'Yuwidget2Widget',
			alias: 'Yuwidget2Widget',
			precondition: undefined,
			// kbOpts: {
			// 	kbExpr: EditorContextKeys.editorTextFocus,
			// 	// primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.KeyI,
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		Yuwidget2Contribution.get(editor).toggle();
	}
}
registerEditorAction(Yuwidget2WidgetAction);
registerEditorContribution(
	Yuwidget2Contribution.ID,
	Yuwidget2Contribution,
	EditorContributionInstantiation.Lazy
);

export class Yuwidget3WidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.Yuwidget3Widget';
	constructor() {
		super({
			id: Yuwidget3WidgetAction.ID,
			label: 'Yuwidget3Widget',
			alias: 'Yuwidget3Widget',
			precondition: undefined,
			// kbOpts: {
			// 	kbExpr: EditorContextKeys.editorTextFocus,
			// 	// primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.KeyI,
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		Yuwidget3Contribution.get(editor).toggle();
	}
}
registerEditorAction(Yuwidget3WidgetAction);
registerEditorContribution(
	Yuwidget3Contribution.ID,
	Yuwidget3Contribution,
	EditorContributionInstantiation.Lazy
);

export class Yuwidget4WidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.Yuwidget4Widget';
	constructor() {
		super({
			id: Yuwidget4WidgetAction.ID,
			label: 'Yuwidget4Widget',
			alias: 'Yuwidget4Widget',
			precondition: undefined,
			// kbOpts: {
			// 	kbExpr: EditorContextKeys.editorTextFocus,
			// 	// primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.KeyI,
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		Yuwidget4Contribution.get(editor).toggle();
	}
}
registerEditorAction(Yuwidget4WidgetAction);
registerEditorContribution(
	Yuwidget4Contribution.ID,
	Yuwidget4Contribution,
	EditorContributionInstantiation.Lazy
);

export class Yuwidget5WidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.Yuwidget5Widget';
	constructor() {
		super({
			id: Yuwidget5WidgetAction.ID,
			label: 'Yuwidget5Widget',
			alias: 'Yuwidget5Widget',
			precondition: undefined,
			// kbOpts: {
			// 	kbExpr: EditorContextKeys.editorTextFocus,
			// 	// primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.KeyI,
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		Yuwidget5Contribution.get(editor).toggle();
	}
}
registerEditorAction(Yuwidget5WidgetAction);
registerEditorContribution(
	Yuwidget5Contribution.ID,
	Yuwidget5Contribution,
	EditorContributionInstantiation.Lazy
);

export class Yuwidget6WidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.Yuwidget6Widget';
	constructor() {
		super({
			id: Yuwidget6WidgetAction.ID,
			label: 'Yuwidget6Widget',
			alias: 'Yuwidget6Widget',
			precondition: undefined,
			// kbOpts: {
			// 	kbExpr: EditorContextKeys.editorTextFocus,
			// 	// primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.KeyI,
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		Yuwidget6Contribution.get(editor).toggle();
	}
}
registerEditorAction(Yuwidget6WidgetAction);
registerEditorContribution(
	Yuwidget6Contribution.ID,
	Yuwidget6Contribution,
	EditorContributionInstantiation.Lazy
);
//////// 29-12-2024
export class BrowserProfileWidgetAction extends EditorAction {
	public static readonly ID = 'editor.action.BrowserProfileWidget';
	constructor() {
		super({
			id: BrowserProfileWidgetAction.ID,
			label: 'BrowserProfileWidget',
			alias: 'BrowserProfileWidget',
			precondition: undefined,
			// kbOpts: {
			// 	kbExpr: EditorContextKeys.editorTextFocus,
			// 	// primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.KeyI,
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		BrowserProfileContribution.get(editor).toggle();
	}
}
registerEditorAction(BrowserProfileWidgetAction);
registerEditorContribution(
	BrowserProfileContribution.ID,
	BrowserProfileContribution,
	EditorContributionInstantiation.Lazy
);
