...
// Aide
import './contrib/yuagent/browser/aideAgentParticipantContributions.js'; // This is done so the container will be registered before views are restored
import './contrib/yuagent/browser/aideAgent.contribution.js';
