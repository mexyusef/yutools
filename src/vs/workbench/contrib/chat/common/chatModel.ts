...
import { IChatCheckpointAdded, IChatCommandGroup, IChatEditsInfo, IChatPlanInfo, IChatPlanStep, IChatRollbackCompleted, IChatThinkingForEditPart } from '../../yuagent/common/aideAgentService.js';
