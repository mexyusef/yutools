...
import { IAideAgentWidgetService } from '../../contrib/yuagent/browser/aideAgent.js';
import { ChatInputPart } from '../../contrib/yuagent/browser/aideAgentInputPart.js';
import { AddDynamicVariableAction, IAddDynamicVariableContext } from '../../contrib/yuagent/browser/contrib/aideAgentDynamicVariables.js';
import { ChatAgentLocation, IAideAgentAgentService, IChatAgentHistoryEntry, IChatAgentImplementation, IChatAgentRequest } from '../../contrib/yuagent/common/aideAgentAgents.js';
import { ChatRequestAgentPart } from '../../contrib/yuagent/common/aideAgentParserTypes.js';
import { ChatRequestParser } from '../../contrib/yuagent/common/aideAgentRequestParser.js';
import { IAideAgentService, IChatContentReference, IChatFollowup, IChatProgress, IChatTask, IChatWarningMessage } from '../../contrib/yuagent/common/aideAgentService.js';
