...
import { IChatRequestVariableValue, IChatVariableData, IChatVariableResolverProgress, IAideAgentVariablesService } from '../../contrib/yuagent/common/aideAgentVariables.js';
