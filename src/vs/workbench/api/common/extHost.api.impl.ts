...
// import {
// 	ExtHostCustomWidgets,
// 	// IExtHostCustomWidgets,
// } from './extHostYuAgent.js';
// import { IWidgetOptions } from '../../contrib/yuagent/customWidgetView.js';
// // import { ICustomWidgetService } from '../../contrib/yuagent/customWidgetService.js';
...
export function createApiFactoryAndRegisterActors(accessor: ServicesAccessor): IExtensionApiFactory {
	...
	// YUAGENT gagal nih
	// Register the MainThreadCustomWidgets service with the rpcProtocol
	// rpcProtocol.set(MainContext.MainThreadCustomWidgets, new MainThreadCustomWidgets(new ExtHostCustomWidgets(rpcProtocol)));
	// rpcProtocol.set(ExtHostContext.ExtHostCustomWidgets, accessor.get(IExtHostLanguageModels));
	...
	// const extHostCustomWidgets = accessor.get(ICustomWidgetService);
	// rpcProtocol.set(ExtHostContext.ExtHostCustomWidgets, extHostCustomWidgets);
	// rpcProtocol.set(ExtHostContext.ExtHostCustomWidgets, new ExtHostCustomWidgets(rpcProtocol));
...
// export function createWindowNamespace(extHostCustomWidgets: ExtHostCustomWidgets, existingWindowNamespace: typeof vscode.window) {
// 	return {
// 		...existingWindowNamespace,
// 		createCustomWidget(widgetId: string, options: IWidgetOptions): Promise<void> {
// 			// Pass the options object to $createWidget
// 			return extHostCustomWidgets.$createWidget(widgetId, options);
// 		},
// 		showCustomWidget(widgetId: string): Promise<void> {
// 			return extHostCustomWidgets.$showWidget(widgetId);
// 		},
// 		hideCustomWidget(widgetId: string): Promise<void> {
// 			return extHostCustomWidgets.$hideWidget(widgetId);
// 		},
// 		disposeCustomWidget(widgetId: string): Promise<void> {
// 			return extHostCustomWidgets.$disposeWidget(widgetId);
// 		},
// 	};
// }
