...
///////////////////////// START YUAGENT /////////////////////////
// export interface ExtHostCustomWidgetsShape {
// 	$createWidget(widgetId: string, options: IWidgetOptions): Promise<void>;
// 	$showWidget(widgetId: string): Promise<void>;
// 	$hideWidget(widgetId: string): Promise<void>;
// 	$disposeWidget(widgetId: string): Promise<void>;
// }
// export interface MainThreadCustomWidgetsShape {
// 	$createWidget(widgetId: string, options: IWidgetOptions): Promise<void>;
// 	$showWidget(widgetId: string): Promise<void>;
// 	$hideWidget(widgetId: string): Promise<void>;
// 	$disposeWidget(widgetId: string): Promise<void>;
...
// export interface ExtHostCustomWidgetsShape {
// 	$createWidget(widgetId: string, title: string, placeholder?: string): Promise<void>;
// 	$showWidget(widgetId: string): Promise<void>;
// 	$hideWidget(widgetId: string): Promise<void>;
// 	$disposeWidget(widgetId: string): Promise<void>;
// }
...
export const MainContext = {
	...
	// ///////////////////////// START YUAGENT
	// // MainThreadMyCustomWidget: createProxyIdentifier<MainThreadMyCustomWidgetShape>('MainThreadMyCustomWidget'),
	// MainThreadCustomWidgets: createProxyIdentifier<MainThreadCustomWidgetsShape>('MainThreadCustomWidgets'),
};
...
export const ExtHostContext = {
	...
	// ///////////////////////// START YUAGENT
	// // ExtHostMyCustomWidget: createProxyIdentifier<ExtHostMyCustomWidgetShape>('ExtHostMyCustomWidget'),
	// ExtHostCustomWidgets: createProxyIdentifier<ExtHostCustomWidgetsShape>('ExtHostCustomWidgets'),
};

// // Define proxy identifiers for the protocol
// export const ExtHostContext = {
// 	// ... existing context ...
// 	ExtHostMyCustomWidget: createExtHostContextProxyIdentifier<ExtHostMyCustomWidgetShape>('ExtHostMyCustomWidget')
// };

// export const MainContext = {
// 	// ... existing context ...
// 	MainThreadMyCustomWidget: createMainContextProxyIdentifier<MainThreadMyCustomWidgetShape>('MainThreadMyCustomWidget')
// };
