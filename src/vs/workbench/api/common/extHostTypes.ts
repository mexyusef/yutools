...
// 	constructor(private proxy: MainThreadMyCustomWidgetShape) { }
// 	show(): void {
// 		this.proxy.$showWidget();
// 	}
// 	hide(): void {
// 		this.proxy.$hideWidget();
// 	}
// }
// export interface MyCustomWidgetAPI {
// 	// // Type 'Event' is not generic.ts(2315)
// 	// // (property) editorId: string
// 	// readonly onDidChangeWidgetState: Event<{ editorId: string; visible: boolean }>;
// 	// readonly onDidChangeWidgetContent: Event<{ editorId: string; content: string }>;
// 	// readonly onDidWidgetInteraction: Event<{ editorId: string; type: 'submit' | 'cancel' }>;
// 	showWidget(): Promise<void>;
// 	hideWidget(): Promise<void>;
// 	updateWidgetContent(content: string): Promise<void>;
// 	isWidgetVisible(): Promise<boolean>;
// 	getWidgetPosition(editorId: string): Promise<{ line: number; column: number } | undefined>;
// }
//#endregion
