		...
		<div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
			<div className="dropdown-container">
				...
				<VSCodeDropdown
					...
					<VSCodeOption value="x.ai">XAI</VSCodeOption>
					<VSCodeOption value="gemini">Google Gemini</VSCodeOption>
					<VSCodeOption value="groq">Groq</VSCodeOption>
					<VSCodeOption value="sambanova">Sambanova</VSCodeOption>
					<VSCodeOption value="hyperbolic">Hyperbolic</VSCodeOption>
				...
				showModelOptions && (
					<>
						<div className="dropdown-container">
							...
							{selectedProvider === "x.ai" && createDropdown(xaiModels)}
							{selectedProvider === "sambanova" && createDropdown(sambaNovaModels)}
							{selectedProvider === "hyperbolic" && createDropdown(hyperbolicModels)}
...
export function normalizeApiConfiguration(apiConfiguration?: ApiConfiguration) {
	...
	switch (provider) {
		...
		case "hyperbolic":
			return getProviderData(hyperbolicModels, hyperbolicDefaultModelId)
		case "groq":
