...
import { VsGentMessage } from "../../../../src/shared/ExtensionMessage";
	...
	return (
		<div style={{ padding: "10px 13px 10px 13px" }}>
            ...
            <span style={{ fontWeight: "bold" }}>Provider:</span>
						{/* <span>{apiConfiguration?.apiProvider}</span> */}
						<span>{JSON.stringify(apiConfiguration)}</span>
            {/* <span>{apiConfiguration?.apiProvider} / {apiConfiguration?.apiModelId}</span> */}
          </div>
