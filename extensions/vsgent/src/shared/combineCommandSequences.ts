import { VsGentMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of VsGentMessages.
 *
 * This function processes an array of VsGentMessages objects, looking for sequences
 ...
 * @returns A new array of VsGentMessage objects with command sequences combined.
 *
 * @example
 * const messages: VsGentMessage[] = [
