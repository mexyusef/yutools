...
const fmus_command = `.,d
	...
	main.go,f(e=C:\\ai\\fulled\\extensions\\fulled\\src\\commands\\directory_context\\go_echo.ts=main.go)
`;

export async function register_dir_context_create_go_echo(context: vscode.ExtensionContext) {
	let disposable = vscode.commands.registerCommand(`${extension_name}.dir_context_create_go_echo`, async (uri: vscode.Uri) => {
