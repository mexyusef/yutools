...
const fmus_command = `.,d
	...
	DIR_PROYEK,d
		src,d
		run.bat,f(n=ls -al)
		main.dart,f(e=C:\\ai\\aide\\extensions\\yutools\\src\\commands\\directory_context\\bot_discord.ts=BACA.md)
`;

export function register_dir_context_create_bot_discord(
	context: vscode.ExtensionContext
) {
	let disposable = vscode.commands.registerCommand(
		`${extension_name}.register_dir_context_create_bot_discord`,
