...
--% BACA.md
bubbles, bubble tea, tea bubble...
gunakan sample code nya saja dulu...

perlu juga utk go prompt...
jadi gunakan 2 main saja...
--#
`;
...
export function register_dir_context_create_go_cli(context: vscode.ExtensionContext) {
	let disposable = vscode.commands.registerCommand(
		`${extension_name}.register_dir_context_create_go_cli`,
