...
export const generateMarkdownLinkForFile = vscode.commands.registerCommand('yutools.dynamic-commands.generateMarkdownLinkForFile', () => {
  ...
  const markdownLink = `[Buka File](command:yutools.dynamic-commands.openDynamicFile?${encodedArgs} "Buka File di editor")`;
