...
export const addFolderToBookmarkUsingDialog = (context: vscode.ExtensionContext) => vscode.commands.registerCommand('yutools.bookmarks.redis.addFolderToBookmarkUsingDialog', async () => {
