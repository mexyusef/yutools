 ...
 */
export const selectedContent2FmusInternal = (
    // backendUrl: string,
    ...
    return async () => {
        try {
            ...
            //     },
            // });
            await runFmus2(selectedText, getEditorDirectoryOrCwd(), responseHandler);
        } catch (error: any) {
 ...
 */
export const selectedContent2Fmus = vscode.commands.registerCommand(
    'yutools.selectedContent2Fmus',
