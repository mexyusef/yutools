...
// Expected Output
// When you run the above code, the agents will:

// Identify tasks that match their goals.

// Use their respective instruments to perform the tasks.
...
// ManagerAgent (manager-1): Working on goal - Coordinate tasks
